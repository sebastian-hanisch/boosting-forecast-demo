"""Gradient Boosting für die Regression (quadratischer Fehler) auf dem Histogramm-Baumkern aus dem LightGBM-Stück (`bf_tree.py`): $F_m = F_{m-1} + \\eta\\,\\mathrm{Baum}_m$, Baum auf den Residuen (Gradient $F - y$, Hesse 1),
